...
# The inputs here are simple text files, which we chop up to
# individual characters and then train GPT on. So you could
# say this is a char-transformer instead of a char-rnn. Doesn't
# quite roll off the tongue as well. In this example we will
